...
import com.laundrypro.app.databinding.ItemCheckoutBinding
import com.laundrypro.app.models.CartItem

class CheckoutAdapter(private val items: List<CartItem>) : RecyclerView.Adapter<CheckoutAdapter.ItemViewHolder>() {
